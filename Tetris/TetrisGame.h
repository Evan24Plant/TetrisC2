...
private:
	...
	// draw where the current shape will fall
	void drawGhost(GridTetromino tetromino, Point origin);
	...
	// Populate the shapeSet with a new set of shapes
	void resetShapeSet();
	...
	std::vector<int> shapeSet;	// the vector of shapes to spawn from
